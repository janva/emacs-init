...
* UI
 Global user interface setttings.
**  Basic UI config
...
Counsel is defined as minor mode.
...
** Org-mode
   Org mode for emacs is similar to markdown but with a lot more functionallity.
for more information see [[https://orgmode.org/][org-mode-pages]]
*** Org basic
...
Is a minor mode providing template system. It features abbreviations that can be expanded automatically into function templates. You can define your own templates and/or use prexisting ones.
 ...
 =yasnippet-snippets= provides predefined snippets for a lot of languages.
